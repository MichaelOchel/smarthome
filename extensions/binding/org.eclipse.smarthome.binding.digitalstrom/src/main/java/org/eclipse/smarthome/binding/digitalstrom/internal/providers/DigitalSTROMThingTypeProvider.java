...
public class DigitalSTROMThingTypeProvider implements ThingTypeProvider {
    ...
    private final List<ChannelDefinition> SW_UMR_CHANNELS = Lists.newArrayList(
            ...
            CHANNEL_DEFINITION_LIGHT_SWITCH, CHANNEL_DEFINITION_GENERAL_SWITCH, CHANNEL_DEFINITION_ACTIVE_POWER,
            CHANNEL_DEFINITION_ELECTRIC_METER_VALUE, CHANNEL_DEFINITION_OUTPUT_CURRENT_VALUE);
