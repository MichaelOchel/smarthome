...
/**
 * The {@link JSONRequestConstants} contains all digitalSTROM-JSON request keys.
 *
...
public interface JSONRequestConstants {
    ...
    public final static String GET_DSID_TO_STRING = "getDSID";
    ...
    public final static String JSON_SYSTEM_GET_DSID = JSON_SYSTEM_PREFIX + GET_DSID_TO_STRING + "?token=";

    // public final static String JSON_SYSTEM_ENABLE_APPLICATION_TOKEN =
    // JSON_SYSTEM_PREFIX+ENABLE_APPLICATION_TOKEN+JSON_TOKEN_AT_LAST_PREFIX;
